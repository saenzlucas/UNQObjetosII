...
class EmpleadoTest {
	...
	Permanente permanenteSoltero = new Permanente("Rodrigo Garcia", "Avellaneda", "Soltero", LocalDate.of(2005, 5, 9), 15000, 2,21);
	...
	Temporario temporarioMas50 = new Temporario("Ezequiel Robles", "Quilmes", "Divorciado", LocalDate.of(1956, 11, 5), 10000,LocalDate.of(2026, 11, 24), 5);
